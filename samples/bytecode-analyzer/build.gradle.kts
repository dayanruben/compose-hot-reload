...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        implementation("org.jetbrains.compose.hot-reload:hot-reload-core:1.3.0-alpha+219")
        implementation("org.jetbrains.compose.hot-reload:hot-reload-analysis:1.3.0-alpha+219")
